...
class WellnessReportExporter {
  ...
  static String generateJsonArchive(WellnessProvider provider) {
    ...
    final data = {
      'export_metadata': {
        'generator': 'Biothrix Wellness Engine',
        'spec_version': '1.0.6',
  ...
  static Uint8List generatePdfBytes(WellnessProvider provider) {
    ...
    streamBuffer.writeln('(BIOTHRIX WELLNESS CLINICAL DOSSIER) Tj');
    ...
    // AI Clinical Summary
    streamBuffer.writeln('BT /F1 9.5 Tf 0.80 1.00 0.00 rg 45 272 Td (BIOTHRIX AI CLINICAL OBSERVATION:) Tj ET');
    ...
    streamBuffer.writeln('30 50 Td (GENERATED BY BIOTHRIX HEALTH CORE v1.0.6  |  CONFIDENTIAL MEDICAL TELEMETRY  |  AUTHENTICITY SIGNATURE: $checksum) Tj');
